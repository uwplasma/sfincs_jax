"""Implicit-differentiation through a full-system GMRES solve (VMEC `geometryScheme=5`).

This example demonstrates *end-to-end differentiability through a linear solve*.
