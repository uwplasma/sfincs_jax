...
- Cases: **10**
- Status counts: fortran_timeout=1, max_attempts=1, parity_mismatch=3, parity_ok=5
...
.. list-table:: Reduced-resolution upstream suite parity status
   ...
   * - transportMatrix_geometryScheme2
     ...
     - 14/194
     - 7/9
     - Common numeric dataset mismatches present. sample=MachUsingFSAThermalSpeed,NTV,NTVBeforeSurfaceIntegral,densityPerturbation printParity=7/9 missing=jacobian,diagnostics
