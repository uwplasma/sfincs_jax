...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| filteredW7XNetCDF_2species_magneticDrifts_noEr | sfincsOutput.h5, sfincs.log | sfincsOutput_jax.h5, sfincs_jax.log | 0.211 | 201.909 | 96000 | 0/193 (strict 0/193) | 9/9 |
