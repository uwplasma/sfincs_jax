...
def test_full_system_rhs_pas_tiny_scheme5_matches_fortran() -> None:
    here = Path(__file__).parent
    ...
    residual_path = here / "ref" / "pas_1species_PAS_noEr_tiny_scheme5.residual.petscbin"
...
def test_full_system_rhs_pas_tiny_scheme1_matches_fortran() -> None:
    here = Path(__file__).parent
    ...
    residual_path = here / "ref" / "pas_1species_PAS_noEr_tiny_scheme1.residual.petscbin"
